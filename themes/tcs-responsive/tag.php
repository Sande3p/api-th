				...
				<div class="rightSplit  grid-3-3">
					<div class="mainStream grid-2-3">
						...
						<div class="subscribeTopWrapper">
							<?php
								$feedUrl = get_bloginfo("wpurl")."/tag/$tag/feed";
							?>
							<a class="currentCatLink rssCat"><span class="hideMobile">Tag '</span><?php echo $tag;?><span class="hideMobile">'</span></a>

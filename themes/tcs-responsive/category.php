				...
				<div class="rightSplit  grid-3-3">
					<div class="mainStream grid-2-3">
						...
						<div class="subscribeTopWrapper">
							...
							?>
							<a class="currentCatLink rssCat"><span class="hideMobile">Browsing '</span><?php echo $catName;?><span class="hideMobile">'</span></a>
							<a class="feedBtn" href="<?php echo $feedUrl;?>">Subscribe<span class="hideMobile"> to <?php echo $catName;?></span></a>
						</div>
						...
						<?php
							...
							$prevLink = add_query_arg("page",($currPage-1),$currUrl);
							$nextLink = add_query_arg("page",($currPage+1),$currUrl);

			...
			<section class="updates">
				...
				<div class="row">
					<form method="post" action="http://www.topcoder.com/newsletter/" onsubmit="return newsletter_check(this)" name="FeedBlitz_9feab01d431311e39e69002590771423" style="display: block" method="POST" action="http://www.feedblitz.com/f/f.fbz?AddNewUserDirect">
						...
						<a type="button" class="btn" value="Submit" onclick="FeedBlitz_9feab01d431311e39e69002590771423s(this.form);" />
						Submit
						</a>
...
<div id="thanks" class="modal">
	...
	<div class="content">
		...
		<p>
			We have sent you an email with a activation instructions.<br />If you do not receive that email within 1 hour, please email
	...
	<div class="content">
		...
		<div id="socials">
			<a class="signin-facebook" href="#">
				<span class="animeButton shareFacebook"><span class="shareFacebookHover animeButtonHover"></span></span>
			</a>
			<a class="signin-google" href="#">
				<span class="animeButton shareGoogle"><span class="shareGoogleHover animeButtonHover"></span></span>
			</a>
			<a class="signin-twitter" href="#">
				<span class="animeButton shareTwitter"><span class="shareTwitterHover animeButtonHover"></span></span>
			</a>
			<a class="signin-github" href="#">
				<span class="animeButton shareGithub"><span class="shareGithubHover animeButtonHover"></span></span>
			</a>
			<p>
				Using an existing account is quick and easy.<br />Select the account you would like to use and we'll do the rest for you
			</p>
			<div class="clear"></div>
		</div>
		<!-- END .socials -->
		...
		<form class="register" id="registerForm">
			<p class="row">
				...
				<span class="err1">Required field</span> <span class="valid"></span>
			</p>
			<p class="row">
			...
			<p class="row">
				...
				<span class="err1">Required field</span> <span class="err2">Handle already exists</span> <span class="valid"></span>
			</p>
			<p class="row">
				<label>Country</label>
			...
			<p class="row">
				...
				<span class="err1">Required field</span> <span class="err2">Invalid email address</span> <span class="valid"></span>
			</p>
			<p class="row">
				<label>Password</label>
				<input type="password" class="pwd" placeholder="Password" />
				<span class="err1">Required field</span> <span class="err2">Password strength is weak</span> <span class="valid">Strong</span>
			</p>
			<p class="row info lSpace">
				<span class="strength"> <span class="field"></span> <span class="field"></span> <span class="field"></span> <span class="field"></span> <span class="field"></span> <span class="field"></span>
				</span> 8 characters with letters &amp; numbers
			</p>
			<p class="row">
				<label>Password Confirmation</label>
				<input type="password" class="confirm" placeholder="Password Confirmation" />
				<span class="err1">Required field</span> <span class="err2">Password confirmation different from above field</span> <span class="valid"></span>
			</p>

			<p class="row lSpace">
				<label><input type="checkbox">I agree to the <a target="_blank" href="/customers/how-it-works/terms/">terms of service</a> and <a target="_blank" href="/customers/how-it-works/privacy-policy/">privacy policy</a>*</label> <span class="err1">You must agree to the terms</span> <span class="err2">You
		...
		<div class="options">
			<div class="person blue">
				<label> <span class="checkBox"><input type="checkbox" />I'm a designer</span> <span class="animeMan manBlue"><span class="manBlueHover animeManHover"></span></span>

				</label>
			</div>
			<!-- END .person -->
			<div class="person green">
				<label> <span class="checkBox"><input type="checkbox" />I'm a developer</span> <span class="animeMan manGreen"><span class="manGreenHover animeManHover"></span></span>
				</label>
			</div>
			<!-- END .person -->
			<div class="person yellow">
				<label> <span class="checkBox"><input type="checkbox" />I'm a algorithmist</span> <span class="animeMan manYellow"><span class="manYellowHover animeManHover"></span></span>
				</label>
			</div>
			<!-- END .person -->
			<div class="person grey">
				<label> <span class="checkBox"><input type="checkbox" />I'm a not sure yet</span> <span class="animeMan manGrey"><span class="manGreyHover animeManHover"></span></span>
				</label>
			</div>
			<!-- END .person -->
			<div class="clear"></div>
	...
	<div class="content">
		...
		<form class="login" id="loginForm">
			<p class="row">
				...
				<span class="err1">Your username or password are incorrect</span> <span class="err2">Please input your password</span>
			</p>
			<p class="row">
				<label>Password</label>

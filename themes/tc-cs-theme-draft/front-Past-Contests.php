<?php
/*
 * Template Name: Front Past Contests
 */
get_header ( 'contests' );
	...
	<div class="rightLayout">
		...
		<div class="mainRail">		
			...
			<script>
				...
				var activePastContest = "past";
				$(document).ready(function() {
					listActiveContest("pastContest","pastContest","<?php echo $contest_type;?>");
				});
			</script>
			<div id="pastContest" class="tc_contest">
				<input type="hidden" class="contestType" value="pastContest"></input>
